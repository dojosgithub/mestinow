                ...
                children: [
                        ...
                        (sym) => DropdownMenuItem<Event>(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(child: Text(sym.getDisplayName(l10n))),
                            ],
                          ),
                        ),
                      ),
                  ...
                  if (showOtherSymptoms) ...[
                      ...
                      Wrap(
                        spacing: 12,
                        runSpacing: 12,
                        children: nonDisplayedSymptoms.map((sym) {
                          return Column(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              IconButton(
                                icon: Image.asset(sym.icon, width: 32, height: 32),
                                onPressed: () {
                                  setState(() {
                                    selectedSymptom = sym;
                                    showOtherSymptoms = false;
                                  });
                                  db.logEvent(sym.code);
                                  _loadEvents();
                                  Navigator.of(context).pop();
                                },
                              ),
                              Text(
                                sym.getDisplayName(l10n),
